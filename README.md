...
- Trainer is redirected to the Dashboard
- Trainer navigates to the Training Session page
- Trainer creates a new session
- Trainer logs out successfully
This ensures that the full user journey works as expected without manual testing.
